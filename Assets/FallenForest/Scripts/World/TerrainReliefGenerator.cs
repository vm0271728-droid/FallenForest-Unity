...
{
    /// <summary>
    /// Generates a natural uneven forest floor from layered deterministic noise. Relief stays
    /// moderate enough for first-person movement while creating hills, depressions and shallow
    /// ravines that remain visible under the flashlight instead of feeling like a flat plane.
    /// </summary>
    ...
    public sealed class TerrainReliefGenerator : MonoBehaviour
    {
        ...
        public void Generate()
        {
            ...
            if (flattenStart)
            {
                ...
                ApplyStartFlatten(heights, resolution, size, normalizedStart, heights[sz, sx]);
            }
