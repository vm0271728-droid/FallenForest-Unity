Shader "FallenForest/TreeFoliageURP"
{
    ...
    SubShader
    {
        ...
        // Do not include SurfaceInput.hlsl here: it declares _BaseMap/sampler_BaseMap itself.
        // This shader owns its texture declarations and only needs Core/Packing + Lighting helpers.
